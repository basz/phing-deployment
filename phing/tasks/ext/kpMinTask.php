 ...
 *
 * @author      Keith Pope\
 * @ see http://www.thepopeisdead.com/main/comments/easy_javascript_css_compression_with_phing/
 */
    ...
    public function main()
    {
        ...
        foreach( $this->filesets as $fs ) 
        {
            try 
            {
                ...
                {
					$target = pathinfo($file, PATHINFO_DIRNAME) . DIRECTORY_SEPARATOR . pathinfo($file, PATHINFO_FILENAME) . '-min.' . pathinfo($file, PATHINFO_EXTENSION);
                    
 			        if (file_exists($fullPath . DIRECTORY_SEPARATOR . $target) && filemtime($fullPath . DIRECTORY_SEPARATOR . $target) >= filemtime($fullPath . DIRECTORY_SEPARATOR . $file)) {
                        continue;
                    }
                    ...
                    $cmd = str_replace( '{target}', $fullPath . DIRECTORY_SEPARATOR . $target, $cmd );
